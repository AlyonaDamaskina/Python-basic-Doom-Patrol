...
def user_add():
    ...
    try:
        ...
        logging.critical("Error: file not found!")
        file = create_file()
    ...
    if check_email(user['Email'], all_users_data) == False:
        ...
        print("such email is used by another user")
...
def search_by(search_str, what_to_search):
    if what_to_search in Config.FIELDS_OF_USER:
        ...
        logging.warning("try to search another value")
        print("wrong query for searching")
